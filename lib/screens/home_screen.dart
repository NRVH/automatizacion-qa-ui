                ...
                child: const Column(
                  ...
                  children: [
                    _ChangelogItem(
                      ...
                      text: 'Versión de prueba para demostrar actualización automática',
                    ),
                    SizedBox(height: 8),
                    _ChangelogItem(
                      icon: Icons.sync,
                      text: 'Sistema de actualización completamente funcional',
                    ),
                    SizedBox(height: 8),
                    _ChangelogItem(
                      icon: Icons.done_all,
                      text: 'Listo para entregar al equipo de QA',
                    ),
                  ],
                ),
              ),
